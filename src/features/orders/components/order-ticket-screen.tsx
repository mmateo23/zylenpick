  ...
  return (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_24rem]">
      <section className="glass-panel rounded-[2.5rem] border border-[color:var(--border)] p-8 shadow-[var(--shadow)]">
        ...
        <div
          id="ticket"
          className="mt-8 rounded-[2rem] border border-[color:var(--border)] bg-[color:var(--surface)] p-6 shadow-[var(--soft-shadow)]"
        >
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <div>
              <p className="text-sm text-[color:var(--muted)]">Fecha</p>
            ...
            <div className="md:col-span-2">
              <p className="text-sm text-[color:var(--muted)]">Dirección del local</p>
              <p className="mt-2 text-base font-semibold text-[color:var(--foreground)]">
          ...
          <div className="mt-6 space-y-3">
            {directionsUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="magnetic-button inline-flex w-full items-center justify-center rounded-full bg-[color:var(--brand)] px-5 py-3.5 text-sm font-semibold text-white"
              >
                Cómo llegar
              </a>
            ) : null}
