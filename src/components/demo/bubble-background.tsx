...
export function BubbleBackground({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(254,212,125,0.16),transparent_26%),linear-gradient(180deg,rgba(4,8,22,0.12),rgba(4,8,22,0.54)_56%,rgba(4,8,22,0.88))]" />
